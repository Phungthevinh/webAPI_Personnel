...
namespace WebAPI.routers
{
    public class chatAIRouter
    {
        ...
        {
            //thêm promts vào 
            app.MapPost("/them-promts", [Authorize] (ai_prompts promts, dbContext db) =>
            {
            ...
            app.MapGet("/promts", [Authorize] (dbContext db, int page, int limit) =>
            {
            ...
            //chỉnh sửa promts
            app.MapPatch("/chinh-sua-promts", [Authorize] (dbContext db, chinh_sua_promts promts) =>
            {
            ...
            //xóa promts
            app.MapDelete("/xoa-promts", [Authorize] ( long id, dbContext db) =>
            {
